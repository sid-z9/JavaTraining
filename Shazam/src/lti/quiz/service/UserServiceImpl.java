...
public class UserServiceImpl implements UserService {
	...
	public RegisterBean authenticate(LoginBean login) {
		...
		String enodedPass = encoder.encodeToString(login.getPassword().getBytes());
		login.setPassword(enodedPass);
	...
	public boolean update(LoginBean change) {
		...
		String ecodedPass = encoder.encodeToString(change.getPassword().getBytes());
		change.setPassword(ecodedPass);
